...
Hi {}, my name is {}! I'm an awesome admin bot managed by [this person](tg://user?id={}).

I'm built with python3 using the python-telegram-bot library. I'm fully open-sourced and ready to help manage your groups.
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("I'm alive and running!")
