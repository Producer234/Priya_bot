...
def extract_user_and_text(message: Message, args: List[str]) -> (Optional[int], Optional[str]):
    ...
    try:
        ...
        if excp.message in ("User_id_invalid", "Chat not found"):
            message.reply_text("I haven't seen this user anywhere... "
                               "Please send me one of their messages or reply to their message, "
                               "so I can identify them and take action.")
        else:
